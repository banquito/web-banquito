...
<div id="post_details">
    ...
    <!-- START OF TAGS --> 
    <div class="tags">
    <span class="strong"><?php _e( 'Tags:', 'featherlite' ); ?></span> <?php the_tags('', ', ', '<br />'); ?> 
    </div><!-- END OF TAGS --> 
    <div class="post_date"><span class="strong"><?php _e( 'Posted On:', 'featherlite' ); ?></span> <?php the_time('F j, Y') ?></div>
    <div class="category"><span class="strong"><?php _e( 'Posted In:', 'featherlite' ); ?></span> <?php the_category(); ?></div>
